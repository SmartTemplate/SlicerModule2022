...
class PathPlannerLogic(ScriptedLoadableModuleLogic):
  ...
  def loadzFrameModel(self):
    ...
    file_path = os.path.join(os.path.dirname(os.path.abspath(__file__)),'Resources','templateLimits.vtk')
    print("script = "+file_path)
    _, self.zFrameModelNode = slicer.util.loadModel(file_path, returnNode=True)
